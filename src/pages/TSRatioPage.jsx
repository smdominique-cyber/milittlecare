...
export default function TSRatioPage() {
  ...
  async function loadAll() {
    ...
    const { data: receipts } = await supabase
      .from('receipts')
      .select('id, merchant, purchase_date, total, amount, category')
      .eq('user_id', licenseeId)
  ...
  return (
    <div className="ts-page">
      ...
      <div style={{
        ...
        <strong>Tax note:</strong> The T/S ratio calculator helps you estimate the business-use portion of shared expenses (Form 8829, Publication 587). MI Little Care provides record-keeping tools, not tax advice. For final filing decisions, consult a qualified tax professional.
      </div>
    </div>
  )
}
