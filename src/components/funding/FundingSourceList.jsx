...
// Tooltip component that works on hover, keyboard focus, AND tap.
// Native title= breaks on mobile and has a ~1s appearance delay; this
// renders a visible bubble immediately and toggles on tap for touch users.
function HelpTooltip({ text, label, children }) {
