...
| 32 | `caregiver_physician_attestation_annual` *(renamed to `_at_renewal` on 2026-06-18; row shipped end-to-end via PR #17/#18 foundation, mig 045 — historical scope-time text preserved)* | R 400.1933 (?) | U: every active caregiver, annual | Pattern E: **NOT YET MODELLED.** No category exists in `staff_training_category` enum. State = unknown ('feature-not-yet-shipped'). | (none yet) | T2 | high |
